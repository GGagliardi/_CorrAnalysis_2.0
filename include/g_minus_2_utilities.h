...
public:
  ...
  double d_11_der_num(double k, double m_rho, double g_rho_pipi, double Mpi);
  double Amplitude(double k, double L, double m_rho, double g_rho_pipi, double Mpi);
  void Find_pipi_energy_lev(double L, double m_rho, double g_rho_pipi, double Mpi, Vfloat &res);
  double V_pipi(double t, double L, double m_rho, double g_rho_pipi, double Mpi, Vfloat &Knpp);
