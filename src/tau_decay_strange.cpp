...
void Compute_tau_decay_width_strange(bool Is_Emax_Finite, double Emax, double beta) {
  ...
  for(int iens=0; iens<Nens;iens++) {
    ...
    for(int is=0; is < (signed)sigma_list_strange.size(); is++) {
      ...
      Br_sigma_Aii_tm = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_tm_1_Aii, prec, SM_TYPE_1,K1, Aii_tm, syst_Aii_tm, mult, lAii_tm, MODE, "tm", "Aii_strange_"+ls_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Zv*Zv, "tau_decay", cov_Ak_tm, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta);
      Br_s_sigma_Aii_tm = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_tm_1_Aii, prec, SM_TYPE_1,K1_shifted, Aii_tm, syst_s_Aii_tm, mult, lAii_tm, MODE, "tm", "Aii_s_strange_"+ls_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Zv*Zv, "tau_decay", cov_Ak_tm, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta);
	...
	cout<<"Elapsed time[Aii_tm, sigma: "<<s<<", Ens: "<<ls_data_tm_VKVK.Tag[iens]<<", rank: "<<rank<<", #thread="<<omp_get_thread_num()<<"] : "<<time_Aii_tm<<" s"<<endl<<flush;
      ...
      Br_sigma_Aii_OS = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_OS_1_Aii, prec, SM_TYPE_1,K1, Aii_OS, syst_Aii_OS, mult, lAii_OS, MODE, "OS", "Aii_strange_"+ls_data_tm_VKVK.Tag[iens], 1e-3,0,resc_GeV*Za*Za, "tau_decay", cov_Ak_OS, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta);
      Br_s_sigma_Aii_OS = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_OS_1_Aii, prec, SM_TYPE_1,K1_shifted, Aii_OS, syst_s_Aii_OS, mult, lAii_OS, MODE, "OS", "Aii_s_strange_"+ls_data_tm_VKVK.Tag[iens], 1e-3,0,resc_GeV*Za*Za, "tau_decay", cov_Ak_OS, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta);
	...
	cout<<"Elapsed time[Aii_OS, sigma: "<<s<<", Ens: "<<ls_data_tm_VKVK.Tag[iens]<<", rank: "<<rank<<", #thread="<<omp_get_thread_num()<<"] : "<<time_Aii_OS<<" s"<<endl<<flush;
      ...
      Br_sigma_Vii_tm = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_tm_1_Vii, prec, SM_TYPE_1,K1, Vii_tm, syst_Vii_tm, mult, lVii_tm, MODE, "tm", "Vii_strange_"+ls_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Za*Za, "tau_decay", cov_Vk_tm, fake_func,0, fake_func_d , Is_Emax_Finite, Emax, beta);
      Br_s_sigma_Vii_tm = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_tm_1_Vii, prec, SM_TYPE_1,K1_shifted, Vii_tm, syst_s_Vii_tm, mult, lVii_tm, MODE, "tm", "Vii_s_strange_"+ls_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Za*Za, "tau_decay", cov_Vk_tm, fake_func,0, fake_func_d , Is_Emax_Finite, Emax, beta);
	...
	cout<<"Elapsed time[Vii_tm, sigma: "<<s<<", Ens: "<<ls_data_tm_VKVK.Tag[iens]<<", rank: "<<rank<<", #thread="<<omp_get_thread_num()<<"] : "<<time_Vii_tm<<" s"<<endl<<flush;
      ...
      Br_sigma_Vii_OS = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_OS_1_Vii, prec, SM_TYPE_1,K1, Vii_OS, syst_Vii_OS, mult, lVii_OS, MODE, "OS", "Vii_strange_"+ls_data_tm_VKVK.Tag[iens],1e-3,0, resc_GeV*Zv*Zv, "tau_decay", cov_Vk_OS, fake_func,0, fake_func_d  ,  Is_Emax_Finite, Emax, beta);
      Br_s_sigma_Vii_OS = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_OS_1_Vii, prec, SM_TYPE_1,K1_shifted, Vii_OS, syst_s_Vii_OS, mult, lVii_OS, MODE, "OS", "Vii_s_strange_"+ls_data_tm_VKVK.Tag[iens],1e-3,0, resc_GeV*Zv*Zv, "tau_decay", cov_Vk_OS, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta);
	...
	cout<<"Elapsed time[Vii_OS, sigma: "<<s<<", Ens: "<<ls_data_tm_VKVK.Tag[iens]<<", rank: "<<rank<<", #thread="<<omp_get_thread_num()<<"] : "<<time_Vii_OS<<" s"<<endl<<flush;
      ...
      Br_sigma_A0_tm = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_tm_A0, prec, SM_TYPE_0,K0, A0_tm, syst_A0_tm, mult, lA0_tm, MODE, "tm", "A0_strange_"+ls_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Zv*Zv, "tau_decay", cov_A0_tm, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta );
      Br_s_sigma_A0_tm = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_tm_A0, prec, SM_TYPE_0,K0_shifted, A0_tm, syst_s_A0_tm, mult, lA0_tm, MODE, "tm", "A0_s_strange_"+ls_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Zv*Zv, "tau_decay", cov_A0_tm, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta );
	...
	cout<<"Elapsed time[A0_tm, sigma: "<<s<<", Ens: "<<ls_data_tm_VKVK.Tag[iens]<<", rank: "<<rank<<", #thread="<<omp_get_thread_num()<<"] : "<<time_A0_tm<<" s"<<endl<<flush;
      ...
      Br_sigma_A0_OS = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_OS_A0, prec, SM_TYPE_0,K0, A0_OS, syst_A0_OS, mult, lA0_OS, MODE, "OS", "A0_strange_"+ls_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Za*Za, "tau_decay", cov_A0_OS, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta );
      Br_s_sigma_A0_OS = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_OS_A0, prec, SM_TYPE_0,K0_shifted, A0_OS, syst_s_A0_OS, mult, lA0_OS, MODE, "OS", "A0_s_strange_"+ls_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Za*Za, "tau_decay", cov_A0_OS, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta );
	...
	cout<<"Elapsed time[A0_OS, sigma: "<<s<<", Ens: "<<ls_data_tm_VKVK.Tag[iens]<<", rank: "<<rank<<", #thread="<<omp_get_thread_num()<<"] : "<<time_A0_OS<<" s"<<endl<<flush;
      ...
      Br_sigma_V0_tm = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_tm_V0, prec, SM_TYPE_0,K0, V0_tm, syst_V0_tm, mult, lV0_tm, MODE, "tm", "V0_strange_"+ls_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Za*Za, "tau_decay", cov_V0_tm, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta );
      Br_s_sigma_V0_tm = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_tm_V0, prec, SM_TYPE_0,K0_shifted, V0_tm, syst_s_V0_tm, mult, lV0_tm, MODE, "tm", "V0_s_strange_"+ls_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Za*Za, "tau_decay", cov_V0_tm, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta );
	...
	cout<<"Elapsed time[V0_tm, sigma: "<<s<<", Ens: "<<ls_data_tm_VKVK.Tag[iens]<<", rank: "<<rank<<", #thread="<<omp_get_thread_num()<<"] : "<<time_V0_tm<<" s"<<endl<<flush;
      ...
      Br_sigma_V0_OS = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_OS_V0, prec, SM_TYPE_0,K0, V0_OS, syst_V0_OS, mult, lV0_OS, MODE, "OS", "V0_strange_"+ls_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Zv*Zv, "tau_decay", cov_V0_OS, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta );
      Br_s_sigma_V0_OS = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_OS_V0, prec, SM_TYPE_0,K0_shifted, V0_OS, syst_s_V0_OS, mult, lV0_OS, MODE, "OS", "V0_s_strange_"+ls_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Zv*Zv, "tau_decay", cov_V0_OS, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta );
	...
	cout<<"Elapsed time[V0_OS, sigma: "<<s<<", Ens: "<<ls_data_tm_VKVK.Tag[iens]<<", rank: "<<rank<<", #thread="<<omp_get_thread_num()<<"] : "<<time_V0_OS<<" s"<<endl<<flush;
      ...
      Br_sigma_Aii_H_tm = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_H_tm_1_Aii, prec, SM_TYPE_1,K1, Aii_H_tm, syst_Aii_H_tm, mult, lAii_H_tm, MODE, "tm", "Aii_strange_H_"+ls_H_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Zv*Zv, "tau_decay", cov_Ak_H_tm, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta);
      Br_s_sigma_Aii_H_tm = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_H_tm_1_Aii, prec, SM_TYPE_1,K1_shifted, Aii_H_tm, syst_s_Aii_H_tm, mult, lAii_H_tm, MODE, "tm", "Aii_s_strange_H_"+ls_H_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Zv*Zv, "tau_decay", cov_Ak_H_tm, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta);
	...
	cout<<"Elapsed time[Aii_H_tm, sigma: "<<s<<", Ens: "<<ls_H_data_tm_VKVK.Tag[iens]<<", rank: "<<rank<<", #thread="<<omp_get_thread_num()<<"] : "<<time_Aii_H_tm<<" s"<<endl<<flush;
      ...
      Br_sigma_Aii_H_OS = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_H_OS_1_Aii, prec, SM_TYPE_1,K1, Aii_H_OS, syst_Aii_H_OS, mult, lAii_H_OS, MODE, "OS", "Aii_strange_H_"+ls_H_data_tm_VKVK.Tag[iens], 1e-3,0,resc_GeV*Za*Za, "tau_decay", cov_Ak_H_OS, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta);
      Br_s_sigma_Aii_H_OS = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_H_OS_1_Aii, prec, SM_TYPE_1,K1_shifted, Aii_H_OS, syst_s_Aii_H_OS, mult, lAii_H_OS, MODE, "OS", "Aii_s_strange_H_"+ls_H_data_tm_VKVK.Tag[iens], 1e-3,0,resc_GeV*Za*Za, "tau_decay", cov_Ak_H_OS, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta);
	...
	cout<<"Elapsed time[Aii_H_OS, sigma: "<<s<<", Ens: "<<ls_H_data_tm_VKVK.Tag[iens]<<", rank: "<<rank<<", #thread="<<omp_get_thread_num()<<"] : "<<time_Aii_H_OS<<" s"<<endl<<flush;
      ...
      Br_sigma_Vii_H_tm = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_H_tm_1_Vii, prec, SM_TYPE_1,K1, Vii_H_tm, syst_Vii_H_tm, mult, lVii_H_tm, MODE, "tm", "Vii_strange_H_"+ls_H_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Za*Za, "tau_decay", cov_Vk_H_tm, fake_func,0, fake_func_d , Is_Emax_Finite, Emax, beta);
      Br_s_sigma_Vii_H_tm = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_H_tm_1_Vii, prec, SM_TYPE_1,K1_shifted, Vii_H_tm, syst_s_Vii_H_tm, mult, lVii_H_tm, MODE, "tm", "Vii_s_strange_H_"+ls_H_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Za*Za, "tau_decay", cov_Vk_H_tm, fake_func,0, fake_func_d , Is_Emax_Finite, Emax, beta);
	...
	cout<<"Elapsed time[Vii_H_tm, sigma: "<<s<<", Ens: "<<ls_H_data_tm_VKVK.Tag[iens]<<", rank: "<<rank<<", #thread="<<omp_get_thread_num()<<"] : "<<time_Vii_H_tm<<" s"<<endl<<flush;
      ...
      Br_sigma_Vii_H_OS = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_H_OS_1_Vii, prec, SM_TYPE_1,K1, Vii_H_OS, syst_Vii_H_OS, mult, lVii_H_OS, MODE, "OS", "Vii_strange_H_"+ls_H_data_tm_VKVK.Tag[iens],1e-3,0, resc_GeV*Zv*Zv, "tau_decay", cov_Vk_H_OS, fake_func,0, fake_func_d  ,  Is_Emax_Finite, Emax, beta);
      Br_s_sigma_Vii_H_OS = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_H_OS_1_Vii, prec, SM_TYPE_1,K1_shifted, Vii_H_OS, syst_s_Vii_H_OS, mult, lVii_H_OS, MODE, "OS", "Vii_s_strange_H_"+ls_H_data_tm_VKVK.Tag[iens],1e-3,0, resc_GeV*Zv*Zv, "tau_decay", cov_Vk_H_OS, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta);
	...
	cout<<"Elapsed time[Vii_H_OS, sigma: "<<s<<", Ens: "<<ls_H_data_tm_VKVK.Tag[iens]<<", rank: "<<rank<<", #thread="<<omp_get_thread_num()<<"] : "<<time_Vii_H_OS<<" s"<<endl<<flush;
      ...
      Br_sigma_A0_H_tm = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_H_tm_A0, prec, SM_TYPE_0,K0, A0_H_tm, syst_A0_H_tm, mult, lA0_H_tm, MODE, "tm", "A0_strange_H_"+ls_H_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Zv*Zv, "tau_decay", cov_A0_H_tm, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta );
      Br_s_sigma_A0_H_tm = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_H_tm_A0, prec, SM_TYPE_0,K0_shifted, A0_H_tm, syst_s_A0_H_tm, mult, lA0_H_tm, MODE, "tm", "A0_s_strange_H_"+ls_H_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Zv*Zv, "tau_decay", cov_A0_H_tm, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta );
	...
	cout<<"Elapsed time[A0_H_tm, sigma: "<<s<<", Ens: "<<ls_H_data_tm_VKVK.Tag[iens]<<", rank: "<<rank<<", #thread="<<omp_get_thread_num()<<"] : "<<time_A0_H_tm<<" s"<<endl<<flush;
      ...
      Br_sigma_A0_H_OS = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_H_OS_A0, prec, SM_TYPE_0,K0, A0_H_OS, syst_A0_H_OS, mult, lA0_H_OS, MODE, "OS", "A0_strange_H_"+ls_H_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Za*Za, "tau_decay", cov_A0_H_OS, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta );
      Br_s_sigma_A0_H_OS = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_H_OS_A0, prec, SM_TYPE_0,K0_shifted, A0_H_OS, syst_s_A0_H_OS, mult, lA0_H_OS, MODE, "OS", "A0_s_strange_H_"+ls_H_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Za*Za, "tau_decay", cov_A0_H_OS, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta );
	...
	cout<<"Elapsed time[A0_H_OS, sigma: "<<s<<", Ens: "<<ls_H_data_tm_VKVK.Tag[iens]<<", rank: "<<rank<<", #thread="<<omp_get_thread_num()<<"] : "<<time_A0_H_OS<<" s"<<endl<<flush;
      ...
      Br_sigma_V0_H_tm = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_H_tm_V0, prec, SM_TYPE_0,K0, V0_H_tm, syst_V0_H_tm, mult, lV0_H_tm, MODE, "tm", "V0_strange_H_"+ls_H_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Za*Za, "tau_decay", cov_V0_H_tm, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta );
      Br_s_sigma_V0_H_tm = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_H_tm_V0, prec, SM_TYPE_0,K0_shifted, V0_H_tm, syst_s_V0_H_tm, mult, lV0_H_tm, MODE, "tm", "V0_s_strange_H_"+ls_H_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Za*Za, "tau_decay", cov_V0_H_tm, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta );
	...
	cout<<"Elapsed time[V0_H_tm, sigma: "<<s<<", Ens: "<<ls_H_data_tm_VKVK.Tag[iens]<<", rank: "<<rank<<", #thread="<<omp_get_thread_num()<<"] : "<<time_V0_H_tm<<" s"<<endl<<flush;
      ...
      Br_sigma_V0_H_OS = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_H_OS_V0, prec, SM_TYPE_0,K0, V0_H_OS, syst_V0_H_OS, mult, lV0_H_OS, MODE, "OS", "V0_strange_H_"+ls_H_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Zv*Zv, "tau_decay", cov_V0_H_OS, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta );
      Br_s_sigma_V0_H_OS = Get_Laplace_transfo(  0.0,  s, E0_l*a_distr.ave(),  T, tmax_H_OS_V0, prec, SM_TYPE_0,K0_shifted, V0_H_OS, syst_s_V0_H_OS, mult, lV0_H_OS, MODE, "OS", "V0_s_strange_H_"+ls_H_data_tm_VKVK.Tag[iens], 1e-3,0, resc_GeV*Zv*Zv, "tau_decay", cov_V0_H_OS, fake_func,0, fake_func_d ,  Is_Emax_Finite, Emax, beta );
	...
	cout<<"Elapsed time[V0_H_OS, sigma: "<<s<<", Ens: "<<ls_H_data_tm_VKVK.Tag[iens]<<", rank: "<<rank<<", #thread="<<omp_get_thread_num()<<"] : "<<time_V0_H_OS<<" s"<<endl<<flush;
      ...
      syst_per_ens_tm_A0[iens][is] = Br_sigma_A0_tm_extr.ave()*max(  sqrt( pow(syst_A0_tm,2)+ pow(syst_s_A0_tm,2))/Br_sigma_A0_tm.ave(),  sqrt( pow(syst_A0_H_tm,2)+ pow(syst_s_A0_H_tm,2))/Br_sigma_A0_H_tm.ave() ); // syst_A0_tm;
      syst_per_ens_tm_V0[iens][is] =  Br_sigma_V0_tm_extr.ave()*max(  sqrt( pow(syst_V0_tm,2)+ pow(syst_s_V0_tm,2))/Br_sigma_V0_tm.ave(),  sqrt( pow(syst_V0_H_tm,2)+ pow(syst_s_V0_H_tm,2))/Br_sigma_V0_H_tm.ave() ); // syst_V0_tm;
      syst_per_ens_tm_Ak[iens][is]=  Br_sigma_Aii_tm_extr.ave()*max(  sqrt( pow(syst_Aii_tm,2)+ pow(syst_s_Aii_tm,2))/Br_sigma_Aii_tm.ave(),  sqrt( pow(syst_Aii_H_tm,2)+ pow(syst_s_Aii_H_tm,2))/Br_sigma_Aii_H_tm.ave() ); // syst_Aii_tm;
      syst_per_ens_tm_Vk[iens][is]=   Br_sigma_Vii_tm_extr.ave()*max(  sqrt( pow(syst_Vii_tm,2)+ pow(syst_s_Vii_tm,2))/Br_sigma_Vii_tm.ave(),  sqrt( pow(syst_Vii_H_tm,2)+ pow(syst_s_Vii_H_tm,2))/Br_sigma_Vii_H_tm.ave() ); // syst_Vii_tm;
      ...
      syst_per_ens_OS_A0[iens][is] = Br_sigma_A0_OS_extr.ave()*max(  sqrt( pow(syst_A0_OS,2)+ pow(syst_s_A0_OS,2))/Br_sigma_A0_OS.ave(),  sqrt( pow(syst_A0_H_OS,2)+ pow(syst_s_A0_H_OS,2))/Br_sigma_A0_H_OS.ave() ); // syst_A0_OS;
      syst_per_ens_OS_V0[iens][is] =  Br_sigma_V0_OS_extr.ave()*max(  sqrt( pow(syst_V0_OS,2)+ pow(syst_s_V0_OS,2))/Br_sigma_V0_OS.ave(),  sqrt( pow(syst_V0_H_OS,2)+ pow(syst_s_V0_H_OS,2))/Br_sigma_V0_H_OS.ave() ); // syst_V0_OS;
      syst_per_ens_OS_Ak[iens][is]=  Br_sigma_Aii_OS_extr.ave()*max(  sqrt( pow(syst_Aii_OS,2)+ pow(syst_s_Aii_OS,2))/Br_sigma_Aii_OS.ave(),  sqrt( pow(syst_Aii_H_OS,2)+ pow(syst_s_Aii_H_OS,2))/Br_sigma_Aii_H_OS.ave() ); // syst_Aii_OS;
      syst_per_ens_OS_Vk[iens][is]=   Br_sigma_Vii_OS_extr.ave()*max(  sqrt( pow(syst_Vii_OS,2)+ pow(syst_s_Vii_OS,2))/Br_sigma_Vii_OS.ave(),  sqrt( pow(syst_Vii_H_OS,2)+ pow(syst_s_Vii_H_OS,2))/Br_sigma_Vii_H_OS.ave() ); // syst_Vii_OS;
  ...
  if(Perform_continuum_extrapolation) {
	...
	distr_t distr_syst_V0V0_tm(UseJack), distr_syst_V0V0_OS(UseJack);
	...
	for(int ijack=0;ijack<Njacks;ijack++) {
	  ...
	  //V0V0
	  distr_syst_V0V0_tm.distr.push_back( GM()*syst_V0V0_tm[iens][is]/sqrt(Njacks-1.0));
	  distr_syst_V0V0_OS.distr.push_back( GM()*syst_V0V0_OS[iens][is]/sqrt(Njacks-1.0));
	...
	//V0V0
	V0V0_tm.distr_list[iens] = V0V0_tm.distr_list[iens] + distr_syst_V0V0_tm;
	V0V0_OS.distr_list[iens] = V0V0_OS.distr_list[iens] + distr_syst_V0V0_OS;
	...
	if(ls_data_tm_VKVK.Tag[iens] == "cB211b.072.64") { id_B64=iens;}
      ...
      //V0V0
      corr_fact_V0V0_FSE_tm = fabs(((V0V0_tm.ave(id_B96) - V0V0_tm.ave(id_B64))/(V0V0_tm.ave(id_B64)))*erf( (V0V0_tm.ave(id_B96)-V0V0_tm.ave(id_B64))/(sqrt(2.0*( pow( V0V0_tm.err(id_B96)  ,2)  + pow( V0V0_tm.err(id_B64) ,2)   )))));
      corr_fact_V0V0_FSE_OS = fabs(((V0V0_OS.ave(id_B96) - V0V0_OS.ave(id_B64))/(V0V0_OS.ave(id_B64)))*erf( (V0V0_OS.ave(id_B96)-V0V0_OS.ave(id_B64))/(sqrt(2.0*( pow( V0V0_OS.err(id_B96)  ,2)  + pow( V0V0_OS.err(id_B64) ,2)   )))));
	...
	distr_syst_FSE_V0V0.distr.push_back( 1.0 + GM()*corr_fact_V0V0_FSE/sqrt(Njacks-1.0));
    ...
    if( Tag_reco_type == "Beta_3.99_Emax_4.0" ) {
      ...
      cout<<" ~ $"<<to_string_with_precision(Vud2*Sew*Final_extr_data[3].ave(),3)<<"~("<<to_string_with_precision(1000*Vud2*Sew*Final_extr_data[3].err(),0)<<")$ ~ &";
      cout<<" ~ $"<<to_string_with_precision(Vud2*Sew*Final_extr_data[8].ave(),3)<<"~("<<to_string_with_precision(1000*Vud2*Sew*Final_extr_data[8].err(),0)<<")$ ~ &";
      ...
      cout<<" ~ $"<<to_string_with_precision(Vud2*Sew*Final_extr_data[4].ave(),3)<<"~("<<to_string_with_precision(1000*Vud2*Sew*Final_extr_data[4].err(),0)<<")$ ~ \\"<<endl;


      cout<<"Ratio V/A "<<endl;
      cout<<"Direct calculation: "<<Final_extr_data[5].ave()<<" +- "<<Final_extr_data[5].err()<<endl;
      cout<<"Ratio (V-A)/(V+A)"<<endl;
      cout<<"Direct calculation: "<<Final_extr_data[6].ave()<<" +- "<<Final_extr_data[6].err()<<endl;
