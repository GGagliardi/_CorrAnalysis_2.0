...
const double Mp_phys_err =  0.0002;
...
void Determine_scale_from_w0_fp(const distr_t_list &Mpi, const distr_t_list &fpi, const distr_t_list &w0, const vector<double> &L_list, const vector<string>  &Ensemble_tags,distr_t &a_distr_A, distr_t &a_distr_B, distr_t &a_distr_C, distr_t &a_distr_D, bool UseJack, bool Use_three_finest) {
  ...
  //Print_To_File
  Print_To_File({Ensemble_tags}, {L_list, Mpi_CDH.ave(), Mpi_CDH.err(), fp_CDH.ave(), fp_CDH.err(), Xpi.ave(), Xpi.err(), Csi_CDH.ave(), Csi_CDH.err()}, "../data/gm2/scale_setting/pion_obs.dat", "", "#Ens L Mpi fp Xpi  Csi");
  ...
  //Perform extrapolation of w0*Xpi or w0*fp
   ...
   //populate bf
    ...
    Print_To_File({}, {csi_p_list, extr_val[0], extr_err[0]}, "../data/gm2/scale_setting/fit_cont_w0Xpi_"+tag_w0X+".dat", "", "# csi val err");
    Print_To_File({}, {csi_p_list, extr_val[1], extr_err[1]}, "../data/gm2/scale_setting/fit_D_w0Xpi_"+tag_w0X+".dat", "", "# csi val err");
    Print_To_File({}, {csi_p_list, extr_val[2], extr_err[2]}, "../data/gm2/scale_setting/fit_C_w0Xpi_"+tag_w0X+".dat", "", "# csi val err");
    Print_To_File({}, {csi_p_list, extr_val[3], extr_err[3]}, "../data/gm2/scale_setting/fit_B_w0Xpi_"+tag_w0X+".dat", "", "# csi val err");
    if(!Use_three_finest) Print_To_File({}, {csi_p_list, extr_val[4], extr_err[4]}, "../data/gm2/scale_setting/fit_A_w0Xpi_"+tag_w0X+".dat", "", "# csi val err");
    ...
    Print_To_File({Corrected_ensemble_list},{w0X_corr_by_FSEs.ave(), w0X_corr_by_FSEs.err(), w0X_uncorr.ave(), w0X_uncorr.err()},  "../data/gm2/scale_setting/data_FSEs_corrected_w0Xpi_"+tag_w0X+".dat", "", "# Ens   corrected   uncorrected");
...
void Determine_scale_from_fp(const distr_t_list &Mpi_phys_point, const distr_t_list &fpi_phys_point, const distr_t_list &Mpi_Bens, const distr_t_list &fpi_Bens, const distr_t_list &Mpi_Aens, const distr_t_list &fpi_Aens,  const vector<double> &L_phys_point, const vector<double> &L_B_ens, const vector<double> &L_A_ens, const vector<string>  &Ensemble_phys_point_tag_list, const vector<string>  &Ensemble_B_tag_list, const vector<string>  &Ensemble_A_tag_list, distr_t &a_distr_A, distr_t &a_distr_B, distr_t &a_distr_C, distr_t &a_distr_D,bool UseJack,bool Use_three_finest_in_scale_setting_fp) {
  ...
  //Print_To_File
  Print_To_File({Ensemble_phys_point_tag_list}, {L_phys_point, Mpi_CDH_phys_point.ave(), Mpi_CDH_phys_point.err(), fp_CDH_phys_point.ave(), fp_CDH_phys_point.err(), Xpi_phys_point.ave(), Xpi_phys_point.err(), Csi_CDH_phys_point.ave(), Csi_CDH_phys_point.err()}, "../data/gm2/scale_setting/pion_obs_phys_point.dat", "", "#Ens L Mpi fp Xpi  Csi");

  Print_To_File({Ensemble_B_tag_list}, {L_B_ens, Mpi_CDH_B.ave(), Mpi_CDH_B.err(), fp_CDH_B.ave(), fp_CDH_B.err(), Xpi_B.ave(), Xpi_B.err(), Csi_CDH_B.ave(), Csi_CDH_B.err()}, "../data/gm2/scale_setting/pion_obs_B_ens.dat", "", "#Ens L Mpi fp Xpi  Csi");

  Print_To_File({Ensemble_A_tag_list}, {L_A_ens, Mpi_CDH_A.ave(), Mpi_CDH_A.err(), fp_CDH_A.ave(), fp_CDH_A.err(), Xpi_A.ave(), Xpi_A.err(), Csi_CDH_A.ave(), Csi_CDH_A.err()}, "../data/gm2/scale_setting/pion_obs_A_ens.dat", "", "#Ens L Mpi fp Xpi  Csi");
  ...
  //Perform extrapolation of afp
   ...
   int Nens_tot = (Nens_B + Nens_A);
    ...
    Print_To_File({}, {csi_p_list, extr_B_val, extr_B_err}, "../data/gm2/scale_setting/fit_B_afp.dat", "", "# csi val err");
    Print_To_File({}, {csi_p_list, extr_A_val, extr_A_err}, "../data/gm2/scale_setting/fit_A_afp.dat", "", "# csi val err");
    ...
    //B ensemble
    Print_To_File({Ensemble_B_tag_list},{afp_corr_by_FSEs_B.ave(), afp_corr_by_FSEs_B.err(), afp_uncorr_B.ave(), afp_uncorr_B.err(), Csi_CDH_B.ave(), Csi_CDH_B.err()},  "../data/gm2/scale_setting/data_FSEs_corrected_afp_B.dat", "", "# Ens   corrected   uncorrected    xi ");

    //A ensemble
    Print_To_File({Ensemble_A_tag_list},{afp_corr_by_FSEs_A.ave(), afp_corr_by_FSEs_A.err(), afp_uncorr_A.ave(), afp_uncorr_A.err(), Csi_CDH_A.ave(), Csi_CDH_A.err()},  "../data/gm2/scale_setting/data_FSEs_corrected_afp_A.dat", "", "# Ens   corrected   uncorrected     xi");
    ...
    //print the result
    Print_To_File({}, {rel_lattice.ave(), rel_lattice.err(), new_lat.ave() , new_lat.err()}, "../data/gm2/scale_setting/a2_scaling.dat", "", "# rel  a(new)");
    //Print_To_File({}, {rel_lattice.ave(), rel_lattice.err(), new_lat.ave() , new_lat.err()}, "../data/gm2/scale_setting/a2_scaling_three_finest.dat", "", "# rel  a(new)");
  ...
  Print_To_File({}, {Xpoints, Fit_func.ave(), Fit_func.err()},"../data/gm2/scale_setting/fit_a2_scaling.dat", "", "");
  //Print_To_File({}, {Xpoints, Fit_func.ave(), Fit_func.err()},"../data/gm2/scale_setting/fit_a2_scaling_three_finest.dat", "", "");
